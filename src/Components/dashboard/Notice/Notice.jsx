...
const Notice = () => {
    return (
        <div className='border mt-7 lg:mx-5 xl:mx-10  p-4 rounded shadow-2xl'>
            <div className='md:grid grid-cols-2 justify-center items-center gap-6'>
                ...
                <div className='w-full h-full border rounded md:mt-0 mt-5'>
                    ...
                    <p className='p-4'>
                        এই সফটওয়্যারটি Tiayra Laser & Aesthetic Center এর জন্য প্রস্তুতকৃত। <br />
            ...
            <div className='md:grid grid-cols-3 justify-center items-center gap-6 mt-10'>
                <div className='w-full h-full border rounded'>
                    ...
                    <button className='bg-blue-500 w-full py-2 hover:bg-blue-600 text-white font-medium'>User list</button>
                </div>
            </div>
        </div>
    )
